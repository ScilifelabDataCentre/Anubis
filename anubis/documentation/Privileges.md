...
The privileges determine which actions are allowed for a logged-in user. The role of the user account controls this. There are three roles:
...
Accounts with the user role can be given additional privileges:
